...
if ($isPerform) {
    //修改信息
    $sql = "UPDATE product SET categoryId = '$categoryId', productName = '$productName', productModel = '$productModel', productUnit = '$productUnit', productPrice = '$productPrice', productIntroduce = '$productIntroduce', productSize = '$productSize', productPic = '$productPic', productDes = '$productDes' WHERE id = '$id';";
